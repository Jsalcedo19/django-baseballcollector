...
"""
Django settings for baseballcollector project.
...
SECRET_KEY = 'django-insecure-k(g@am5koz4gpi$_vl%im)^mbi4(a&_4922*dxri07lmtk-oje'
...
ROOT_URLCONF = 'baseballcollector.urls'
...
WSGI_APPLICATION = 'baseballcollector.wsgi.application'
